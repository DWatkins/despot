...
#define JOINT_POSITIONS 4
#define JOINT_INCREMENT 2
#define GRID_INCREMENT 1
#define TOTAL_SWITCH_POSITIONS 10
#define DEBUG_SWITCH_INIT_POSITION 9
...
namespace despot {
  ...
  public:
	...
	int switch_position; //position of the switch
